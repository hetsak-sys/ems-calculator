...
**VERIFIED ON-DEVICE 2026-07-29 by Hertz** — all scenarios below passed on the reference device (release build, fresh clone of `5afcf9d`, 482/482 confirmed pre-build). Sections 1–3 and 5–7 remain owed.
